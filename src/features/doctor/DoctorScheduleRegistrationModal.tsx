...
const scheduleTemplates: ScheduleTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Lịch cuối tuần với thời gian linh hoạt cho bệnh nhân khó khăn",
    timeSlots: [
      "09:00",
      "09:45",
      "10:30",
...
export default function DoctorScheduleRegistrationModal({
  ...
  const { createSchedule, bulkCreateSchedule, isLoading, error } =
    useDoctorSchedule();
  ...
  useEffect(() => {
    if (formData.date && formData.timeSlots.length > 0) {
      const conflictingSlots = formData.timeSlots.filter((slot) =>
        existingSchedules.some(
          (schedule) =>
            schedule.date === formData.date && schedule.timeSlots.includes(slot)
        )
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (formData.recurring) {
        ...
        if (result) {
          toast.success(
            `Đã tạo thành công lịch làm việc cho ${recurringDates.length} ngày!`
          );
        }
      } else {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p
                  className="text-[#334155] mt-1"
                  style={{
                    display: "none",
                  }}
                >
                  Tạo lịch làm việc mới cho bệnh nhân đặt hẹn
                </p>
              </div>
            </div>
            <button
              onClick={onClose}
              className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-2xl flex items-center justify-center transition-colors group"
            >
              <X
                size={20}
                className="text-[#334155] group-hover:text-[#0F172A]"
              />
            </button>
          </div>
                  ...
                  <div key={step.id} className="flex items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="hidden md:block">
                        <p
                          className={`font-medium ${isActive ? "text-[#1E75FF]" : isCompleted ? "text-[#10B981]" : "text-[#334155]"}`}
                        >
                          Bước {step.id}
                        </p>
                ...
                <div className="space-y-8">
                  <div>
                    <h3 className="text-xl font-semibold text-[#0F172A] mb-2">
                      Chọn ngày và khung giờ làm việc
                    </h3>
                    <p
                      className="text-[#334155] mb-6"
                      style={{
                        display: "none",
                      }}
                    >
                      Chọn ngày và khung giờ bạn muốn đăng ký lịch làm việc
                    </p>
                      ...
                      <div className="space-y-6">
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#1E75FF] focus:border-transparent text-lg"
                          />
                        </div>
                        ...
                        <div className="space-y-3">
                          <label className="block text-sm font-medium text-[#334155]">
                            <Zap
                              size={16}
                              className="inline mr-2 text-[#F59E0B]"
                            />
                            Chọn nhanh theo buổi
                          </label>
                          <p className="text-xs text-[#334155] mb-3">
                            Chọn nhanh khung giờ cơ bản theo buổi làm việc
                          </p>
                          <div className="grid grid-cols-1 gap-3">
                            <button
                              onClick={() => applyQuickPreset("morning")}
                              className="flex items-center gap-3 p-4 border border-gray-200 rounded-2xl hover:border-[#F59E0B] hover:bg-[#F59E0B]/5 transition-all group"
                            >
                              ...
                              <div className="text-left">
                                <p className="font-medium text-[#0F172A] group-hover:text-[#F59E0B]">
                                  Buổi sáng
                                </p>
                                <p className="text-sm text-[#334155]">
                                  8:00 - 12:00 (8 khung giờ)
                                </p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="text-left">
                                ...
                                <p className="text-sm text-[#334155]">
                                  14:00 - 17:30 (8 khung giờ)
                                </p>
                              </div>
                            </button>

                            <button
                              onClick={() => applyQuickPreset("full-day")}
                              className="flex items-center gap-3 p-4 border border-gray-200 rounded-2xl hover:border-[#F59E0B] hover:bg-[#F59E0B]/5 transition-all group"
                            >
                        ...
                        >
                          <label className="block text-sm font-medium text-[#334155]">
                            <BookOpen
                              size={16}
                              className="inline mr-2 text-[#1E75FF]"
                            />
                            Mẫu lịch từ lịch sử
                          </label>
                          <p className="text-xs text-[#334155] mb-3">
                            Sử dụng lại các mẫu lịch đã tạo trước đây với cấu
                            hình chi tiết
                          </p>
                          <div className="space-y-2 max-h-64 overflow-y-auto">
                            {scheduleTemplates.map((template) => (
                              <button
                                ...
                                className="w-full flex items-start gap-3 p-4 border border-gray-200 rounded-xl hover:border-[#1E75FF] hover:bg-[#1E75FF]/5 transition-all text-left group"
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1">
                                    <p className="font-medium text-[#0F172A] group-hover:text-[#1E75FF] truncate">
                                      {template.name}
                                    </p>
                                    {template.usage > 10 && (
                                      <Star
                                  ...
                                  <p className="text-xs text-[#334155] mb-2 line-clamp-2">
                                  ...
                                  <div className="flex items-center gap-4 text-xs text-[#334155]">
                                    ...
                                    <span className="flex items-center gap-1">
                                      <Timer size={10} />
                                      <span>
                                        {template.timeSlots.length} slot
                                      </span>
                                    </span>
                                  </div>
                                </div>
                      ...
                      <div className="xl:col-span-2 space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="text-sm text-[#EF4444] hover:text-[#DC2626] font-medium flex items-center gap-1"
                          >
                            <RotateCcw size={14} />
                          ...
                          <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
                            {timeSlots.map((slot) => (
                              <motion.button
                                ...
                                onMouseDown={() => handleDragStart(slot.id)}
                          ...
                          <div className="mt-6 text-center">
                            <p className="text-sm text-[#334155]">
                              ...
                              <span className="font-medium text-[#1E75FF]">
                                {
                                  timeSlots.filter((slot) => slot.selected)
                                    .length
                                }
                              </span>{" "}
                              khung giờ
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-[#334155] mt-1">
                                  Các khung giờ sau đã có lịch hẹn:{" "}
                                  {conflicts.join(", ")}
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="mt-6 p-4 bg-gradient-to-r from-[#10B981]/10 to-[#1E75FF]/10 rounded-2xl border border-[#10B981]/20">
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              ...
                              onChange={(e) =>
                                setFormData((prev) => ({
                                  ...
                                  recurringType: e.target.checked
                                    ? "endDate"
                                    : prev.recurringType,
                                }))
                              }
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-[#334155] mt-1">
                                Tạo lịch liên tiếp từ ngày bắt đầu đến ngày kết
                                thúc
                              </p>
                            </div>
                          </label>
                          ...
                          {formData.recurring && (
                            <div className="mt-4">
                              <div className="flex items-center gap-3">
                                <label className="text-sm font-medium text-[#334155] whitespace-nowrap">
                                  Lặp đến ngày
                                </label>
                                <input
                                  type="date"
                                  ...
                                  min={selectedDate}
                                  className="flex-1 px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1E75FF] text-sm"
                                />
                              </div>
                            </div>
                          )}
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-[#334155] mb-6">
                      Kiểm tra lại thông tin trước khi lưu lịch làm việc
                    </p>
                  </div>
                      ...
                      <div className="bg-white rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between py-3 border-b border-gray-100">
                            ...
                            <span className="font-medium text-[#1E75FF]">
                              {timeSlots.filter((slot) => slot.selected).length}{" "}
                              khung giờ
                            </span>
                          </div>
                          ...
                          <div className="flex items-center justify-between py-3 border-b border-gray-100">
                            ...
                            <span
                              className={`px-3 py-1 rounded-full text-sm font-medium ${formData.type === "available" ? "bg-[#10B981]/10 text-[#10B981]" : "bg-[#EF4444]/10 text-[#EF4444]"}`}
                            >
                      ...
                      <div className="bg-white rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-4 gap-2">
                          {timeSlots
                            ...
                            .map((slot) => (
                              <div
                                key={slot.id}
                                className="bg-[#1E75FF]/10 border border-[#1E75FF]/20 rounded-xl p-3 text-center"
                              >
                                <span className="text-sm font-medium text-[#1E75FF]">
                                  {slot.time}
                                </span>
                              </div>
                            ))}
                        ...
                        {formData.note && (
                          <div className="mt-6">
                            ...
                            <p className="text-sm text-[#0F172A] bg-gray-50 rounded-xl p-3">
                              {formData.note}
                            </p>
                          </div>
                        )}
                    ...
                    {showConflictWarning && (
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h5 className="font-semibold text-[#EF4444] mb-2">
                              Cảnh báo xung đột lịch
                            </h5>
                            <p className="text-[#334155] mb-3">
                              Các khung giờ sau đã có lịch hẹn và sẽ bị ghi đè:{" "}
                              <strong>{conflicts.join(", ")}</strong>
                            </p>
                            <p className="text-sm text-[#334155]">
                              Bạn có chắc chắn muốn tiếp tục? Điều này có thể
                              ảnh hưởng đến các lịch hẹn hiện có.
                            </p>
                          </div>
                        </div>
                      </motion.div>
        ...
        <div className="px-8 py-6 border-t border-gray-100 bg-gray-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              {currentStep > 1 && (
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 text-[#334155] rounded-2xl font-medium hover:bg-gray-50 transition-colors"
                >
                  <ChevronLeft size={16} />
                  <span>Quay lại</span>
                </button>
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={onClose}
                className="px-6 py-3 bg-white border border-gray-200 text-[#334155] rounded-2xl font-medium hover:bg-gray-50 transition-colors"
              >
                Hủy bỏ
              </button>
              ...
              {currentStep < 2 ? (
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-[#1E75FF] hover:bg-[#1659C9] text-white rounded-2xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span>Tiếp theo</span>
                ...
                <button
                  onClick={handleSave}
                  disabled={isLoading}
                  className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-[#10B981] to-[#059669] hover:from-[#059669] hover:to-[#047857] text-white rounded-2xl font-medium transition-all shadow-lg shadow-[#10B981]/25 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
