  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgb(30, 117, 255) 0%, rgb(22, 89, 201) 100%)",
        }}
      >
        <div className="text-center">
          ...
          >
            Hôm nay là Thứ Tư, 20 tháng 8, 2025
          </p>
        </div>
      </div>
            ...
            {upcomingAppointments.map((appointment, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <p className="text-lg font-bold text-[#1E75FF]">
                      {appointment.time}
                    </p>
                  </div>
                  <div>
      ...
      <div
        className="bg-white rounded-2xl shadow-[0_10px_24px_rgba(16,24,40,0.08)] p-6"
        style={{
          display: "none",
        }}
      >
        ...
        <div className="bg-[#1E75FF]/5 border border-[#1E75FF]/20 rounded-xl p-4">
          <p className="text-[#334155]">
            <strong className="text-[#0F172A]">Cập nhật hệ thống:</strong> Tính
            năng AI hỗ trợ chẩn đoán CKD đã được cập nhật với độ chính xác cao
            hơn.
          </p>
        </div>
      </div>
