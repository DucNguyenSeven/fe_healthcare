...
export type NavigationItem = 'dashboard' | 'profile' | 'appointments' | 'telehealth' | 'monitoring' | 'ai-assistant' | 'community' | 'settings';
    ...
    switch (currentPage) {
      ...
      case 'settings':
        return <div className="p-6">
            <h1 className="text-2xl font-semibold text-gray-900 mb-4">Cài đặt</h1>
