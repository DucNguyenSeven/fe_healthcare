        ...
        patientQuestions.map((question, index) => (
          ...
          >
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {question.tags.map((tag: string) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-[#1E75FF]/10 text-[#1E75FF] rounded-full text-sm font-medium flex items-center gap-1"
                    >
                      <Tag size={12} />
                      {tag}
                    </span>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setShowReplyModal(question.id)}
              ...
              <button
                ...
                className="bg-[#EF4444] hover:bg-[#DC2626] text-white px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition-colors"
              >
                <EyeOff size={16} />
                <span>Ẩn</span>
              </button>
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${
                      article.category === "Nghiên cứu"
                        ? "bg-[#1E75FF]/10 text-[#1E75FF]"
                        : article.category === "Công nghệ"
                        ? "bg-[#F59E0B]/10 text-[#F59E0B]"
                        : article.category === "Dinh dưỡng"
              ...
              <div className="mb-4">
                <div className="p-4 bg-gray-50 rounded-xl mb-4">
                  <h4 className="font-medium text-[#0F172A] mb-2">
                    {
                      patientQuestions.find((q) => q.id === showReplyModal)
                        ?.title
                    }
                  </h4>
