...
export function TelehealthPage({ user, appointments }: TelehealthPageProps) {
  const [currentView, setCurrentView] = useState<TelehealthView>("lobby");
  const [activeTab, setActiveTab] = useState<
    "chat" | "profile" | "prescription"
  >("chat");
  ...
  const upcomingAppointment = appointments.find(
    (apt) => apt.status === "upcoming" && apt.type === "online"
  );
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm text-gray-600">
                  {getDeviceStatusText(deviceStatus.microphone)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm text-gray-600">
                  {getDeviceStatusText(deviceStatus.camera)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm text-gray-600">
                  {getDeviceStatusText(deviceStatus.network)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <p className="text-blue-900 font-medium">
              Yêu cầu trước khi tư vấn
            </p>
            <p className="text-blue-800 text-sm mt-1">
              Vui lòng chuẩn bị chỉ số xét nghiệm trong 90 ngày gần nhất để bác
              sĩ có thể tư vấn chính xác nhất.
            </p>
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {activeTab === "prescription" && (
            <div className="p-4 space-y-4">
              ...
              <textarea
                readOnly
                className="w-full h-32 p-3 border border-gray-300 rounded-lg bg-gray-50 text-sm"
                placeholder="Bác sĩ sẽ ghi chỉ định tại đây..."
                value="1. Tiếp tục dùng Losartan 50mg, 1 viên/ngày&#10;2. Giảm lượng muối trong bữa ăn&#10;3. Tái khám sau 2 tuần&#10;4. Theo dõi huyết áp hàng ngày"
              />
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="prose prose-sm max-w-none">
          ...
          <h3>Lưu ý:</h3>
          <p>
            Nếu có triệu chứng khó thở, phù chân tăng, liên hệ ngay với bác sĩ.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div
        className={`flex-1 ${
          currentView === "session" ? "" : "p-4 lg:p-6"
        } overflow-auto`}
      >
