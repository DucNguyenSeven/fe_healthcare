...
import { Send, Bot, User, Upload, FileText, Clock, Trash2, MessageCircle, AlertTriangle, Activity, Droplets, Heart } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="space-y-4">
        {uploadAnalyses.map(analysis => (
          <div key={analysis.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-4">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                ...
                {analysis.status === 'completed' ? 'Hoàn thành' :
                 analysis.status === 'processing' ? 'Đang xử lý' : 'Lỗi'}
              </span>
            </div>
        ...
        <div className="flex space-x-8">
          <button
            ...
            className={`py-4 px-2 border-b-2 font-medium text-sm ${
              currentView === 'chat' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
            Trò chuyện
          </button>
          <button
            ...
            className={`py-4 px-2 border-b-2 font-medium text-sm ${
              currentView === 'upload' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
            Phân tích file
          </button>
